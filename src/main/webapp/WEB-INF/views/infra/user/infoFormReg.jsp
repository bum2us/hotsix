...
<body>
	<div class="container">
        ...
        <div class="searchForm row justify-content-center text-center" style="padding: 20px; ">
            <span style="font-size: 16pt; font-weight: bolder; margin-bottom: 10px;"><c:out value="${meminfo.name}"/>님</span>
        ...
        <div class="row justify-content-center">
            <button class="basebutton" type="button" style="width:200px; margin:30px 0px 30px 0px;" onclick="location.href='/login'">로그인 화면으로</button>
        </div>
